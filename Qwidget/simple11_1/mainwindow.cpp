...
void MainWindow::on_radioBtnAscend_clicked(bool checked)
{
    Q_UNUSED(checked);
    tabModel->setSort(ui->comboFields->currentIndex(),Qt::AscendingOrder);
}

void MainWindow::on_radioBtnDescend_clicked(bool checked)
{
    Q_UNUSED(checked);
    tabModel->setSort(ui->comboFields->currentIndex(),Qt::DescendingOrder);
}

void MainWindow::on_radioBtnMan_clicked(bool checked)
{
     Q_UNUSED(checked);
    tabModel->setFilter(" Gender='男' ");
}

void MainWindow::on_radioBtnWoman_clicked(bool checked)
{
   Q_UNUSED(checked);
   tabModel->setFilter(" Gender='女' ");
}

void MainWindow::on_radioBtnBoth_clicked(bool checked)
{
    Q_UNUSED(checked);
    tabModel->setFilter("");
}
